...
//    initializer.setInstancesForObject(PresenceDetector.OBJECT_ID, pdetect);
//
//    Luminaire luminaire = new Luminaire();
//    String lType = (cli.luminaire != null && cli.luminaire.type != null) ? cli.luminaire.type : "LED";
//    long lPower = (cli.luminaire != null) ? cli.luminaire.peakpower : 100;
//    luminaire.configure(lType, lPower);
//    initializer.setInstancesForObject(Luminaire.OBJECT_ID, luminaire);
//
//    DemandResponse demand = new DemandResponse();
//    int dMax = (cli.demandresponse != null) ? cli.demandresponse.maxpower : 2000;
//    demand.configure(dMax);
